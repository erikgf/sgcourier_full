            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Gestión de <span class="text-danger">CATÁLOGOS</span> LEONISA</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Gestión de Catálogos LEONISA</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Lista de <span class="text-danger">CATÁLOGOS</span>  </h5>
                                <div class="row">
                                    <div class="col-sm-3">
        ...
        <div class="modal-dialog modal-lg" role="document ">
            <form id="frm-registro" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Registrar <span class="text-danger">CATÁLOGOS</span> del Día</h5>
                ...
                <div class="modal-body">
                  ...
                  <input type="hidden"  name="txttipopedido" id="txttipopedido" required value="2">
                  <div class="row">
                      <div class="col-sn-12">
