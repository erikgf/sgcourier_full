...
var ID_CLIENTE_ESPECIFICO = _KEYLEONISA;
                  ...
                  <div class="row">
                      <div class="col-sm-3">
                          <div class="form-group m-t-10">
                              ...
                              <p id="txttelefono">`+data_orden.telefonos+`</p>
                          </div>
                      </div>
                      <div class="col-sm-3">
                          <div class="form-group m-t-10">
                              <label for="txttelefono">Total Unidades</label>
                              <p id="txttelefono">`+data_orden.total_unidades+`</p>
                          </div>
                      </div>
                      <div class="col-sm-2">
                          <div class="form-group m-t-10">
