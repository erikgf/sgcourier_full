...
<head>
    ...
    <style type="text/css">
        .blk-misasignaciones{
            background-color: #8091f0!important;
            color: white;
        }
...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"  id="blkmain" style="display:none">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                      <div class="form-group m-t-10">
                                        <label>Cantidad: <b id="lblcantidad"></b> </label>
                                        <br>
                                        <span class="badge badge-large badge-dark">NO ASIGNADO</span> <span id="lblcantidadnoasignado" class="badge badge-pill badge-dark"></span>
                                        <span class="badge badge-large badge-info">GESTIONANDO</span> <span id="lblcantidadgestionando" class="badge badge-pill badge-info"></span>
                                        <span class="badge badge-large badge-success">ENTREGADO</span> <span id="lblcantidadentregados" class="badge badge-pill badge-success"></span>
                                        <span class="badge badge-large badge-danger">MOTIVADO</span> <span id="lblcantidadmotivados" class="badge badge-pill badge-danger"></span>
                                      </div>
                                    </div>
                                    <div class="col-sm-2">
    ...
    <script type="text/javascript" src="index.agencia_v2.js"></script>
