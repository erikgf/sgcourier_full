var TABLA,
	COL_DEFS = [85, 100, 200, 100, 100,250,150,100,125,100,100,85];
var DATA = {};
...
var renderDetalleTabla = function (data) {
	...
	for (var i = 0; i < data.length; i++){
		...
		html += 	`</td>
					...
					<td>`+o.pronabec_sigedo+`</td>
					<td>`+o.pronabec_oficina+`</td>
					<td>`+o.pronabec_orden+`</td>
					<td>`+o.pronabec_correlativo+`</td>
