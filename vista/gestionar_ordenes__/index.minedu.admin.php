...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Gestión de Órdenes MINEDU</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Gestión de Órdenes MINEDU</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        var _KEY = <?php echo GlobalVariables::$ID_MINEDU; ?>;
    </script>
