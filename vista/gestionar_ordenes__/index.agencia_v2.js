...
var eventos = function() {
	$tbl.on("change", "tbody tr .chkseleccion", function() {
		var $inputCheck = this,
...
var generarExcelEntregas = function(){
	window.open("../../controlador/reporte.pedidos.leonisa.xls.php?p_id="+_ID,"_blank");
};
