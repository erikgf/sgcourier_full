var TABLA,
	COL_DEFS = [85, 100, 200, 80, 100,250,150,225,125,125,125,85];
var DATA = {};
...
var renderDetalleTabla = function (data) {
	...
	for (var i = 0; i < data.length; i++){
		...
		html += 	`</td>
					...
					<td>`+o.minedu_tipo_documento+`</td>
					<td>`+o.minedu_nro_doc+`</td>
					<td>`+o.destinatario+`</td>
					<td>`+o.ubigeo+`</td>
					<td>`+o.direccion_uno+`</td>				
					<td>`+o.minedu_cobertura+`</td>
					<td>`+o.minedu_prioridad+`</td>
					<td>`+o.minedu_oficina+`</td>
