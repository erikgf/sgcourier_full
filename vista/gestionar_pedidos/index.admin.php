...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document ">
            <form id="frm-registro" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Registrar Excel</h5>
                  ...
                  <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group m-t-10">
                                ...
                                <select class="select2 form-control"  id="txtclienteregistro" required name="txtclienteregistro" style="width: 100%; height:36px;">
    ...
    ?>
    <script type="text/javascript" src="index.admin_v1.js"></script>
</body>
