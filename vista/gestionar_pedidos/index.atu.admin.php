...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Gestión de Docs ATU</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Gestión de Docs ATU</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-7">
                            <div class="form-group m-t-10">
                                ...
                                <select class="form-control"  id="txtclienteregistro" required name="txtclienteregistro">
                                    <option value="<?php echo GlobalVariables::$ID_ATU; ?>" selected>[-] Asociación de Transporte Urbano - ATU </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-2">
    ...
    ?>
    <script type="text/javascript" src="index.atu.admin.js"></script>
</body>
