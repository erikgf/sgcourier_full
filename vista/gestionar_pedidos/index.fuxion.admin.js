	...
	for (var i = 0; i < data.length; i++){
		...
		html += `<tr>
					<th scope="row" class="text-center">
						<a title="VER" target="blank" href="../gestionar_ordenes/index.fuxion.admin.php?p_id=`+o.id+`" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a>	
...
var listar = function() {
	var postData = {
	  ...
	  $.post("../../controlador/pedidos.php?op=listar_fuxion", postData)
	      .done(fn)
	      .fail(fnFail);
};
