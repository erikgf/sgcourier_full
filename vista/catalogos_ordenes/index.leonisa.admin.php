...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Gestión de Catálogos Indv. LEONISA</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Gestión de Catálogos Indv. LEONISA</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body" id="blkmain" style="display:none">
                                <h5 class="card-title">Órdenes de Catálogo: <small>ID: <span id="lblpedido"></span></small></h5>
                                <div class="row">
                                    <div class="col-sm-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                      <div class="form-group m-t-10">
                                          <br>
                                          <button type="button" class="btn btn-danger btn-block" id="btn-etiquetas">
                                            <i class="fa fa-file-pdf"></i> ETIQUETAS
                                          </button>
                                      </div>
                                    </div>
                                    <div class="col-sm-2">
                                      <div class="form-group m-t-10">
                                          <br>
                                          <button disabled type="button" class="btn btn-success btn-block" id="btn-excel">
    ...
    <script type="text/javascript">
        ...
        var _KEYLEONISA = <?php echo GlobalVariables::$ID_LEONISA; ?>;
    </script>
    <script type="text/javascript" src="index.leonisa.catalogos.admin.js"></script>
</body>
